...
export default function Home() {
  return (
    <div className="relative overflow-hidden">
      ...
      />
      <div className="relative sm:h-[100vh]  h-[65vh] lg:h-[100vh]">
        <div className="relative sm:h-[100vh] h-[65vh] lg:h-[100vh] m-5 z-10 space-y-5">
          ...
          <div className="rounded-xl h-full relative z-10 bg-[#0b0319] herobox-border">
            ...
            <div className="flex flex-row justify-center items-center h-[80%] relative flex-col-reverse md:flex-row">
              <div className="flex flex-col flex-wrap md:pl-0 pl-3 pt-4 lg:p-4 w-full space-y-5 absolute z-10 md:relative md:w-1/2 md:ml-20 md:space-y-5 translate-y-[-50px] ">
